...
import { Download, Filter, LogOut, Truck, CheckCircle2, XCircle, Search, RefreshCw, Eye } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-secondary-text">Panel del Gerente (Lectura + Auditoría) — {user?.nombre}</p>
            </div>
          </div>
